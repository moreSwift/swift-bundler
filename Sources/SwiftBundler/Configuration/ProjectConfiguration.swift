...
struct ProjectConfiguration: Codable, Hashable, Sendable {
  ...
  enum Builder: Codable, Flattenable, Sendable, Hashable {
  ...
  enum APIRequirement: Hashable, Sendable {
  ...
  struct Product: Codable, Sendable, Hashable {
    ...
    enum PrebuiltLocation: Codable, TriviallyFlattenable, Hashable, Sendable {
    ...
    /// A type of product.
    enum ProductType: String, Codable, TriviallyFlattenable, Hashable, Sendable {
